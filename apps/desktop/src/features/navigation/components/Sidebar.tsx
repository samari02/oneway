...
import { useCompanionDesignVariant, setCompanionDesignVariant } from '@/features/clarity-home/hooks/useCompanionDesignVariant'
import './Sidebar.css'

export type ViewType = 'today' | 'clarity-home' | 'tasks' | 'progress' | 'screen-time' | 'boundaries' | 'settings'
...
export function Sidebar({ currentView, onNavigate, onPinnedChange }: SidebarProps) {
  ...
  const toggleVariant = () => setCompanionDesignVariant(isMonk ? 'orb' : 'monk')
